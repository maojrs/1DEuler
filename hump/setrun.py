...
#------------------------------
    ...
    probdata.add_param('gammaplas',     1.1,  'gamma for ideal gas')
    probdata.add_param('gammawat',     7.15,  'gamma for water') # 2.5 before
    probdata.add_param('pinfgas',     0.0,  'pinf for stiffend gas/plastic')
    # pinfplas Calculated with c^2=gamma*(p+p0)/rho to make c =2240m/s (polyestirene speed of sound)
    probdata.add_param('pinfplas',     4789425947.72,  'pinf for stiffend gas/plastic') 
    probdata.add_param('pinfwat',      300000000.0,  'pinf for stiffend water') #Previously 880801075.0
    ...
    clawdata.lower[0] = -1.600000e+01          # xlower
